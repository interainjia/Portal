<%@ Page Title="" Language="C#" MasterPageFile="~/MP.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MSE3Portal.Default" %>
		...
		<div id="masonry_ghost" class="hide">
			...
			<div class="thumbnail">
				...
				<div class="caption">
					...
					<div class="author">
						by <a target="_blank" href="mailto:Weiyan.LU@cn.bosch.com?subject=Suggestion for FPY&body=Thanks for your email">Lu Weiyan(AE/PJ-SME3-CN)</a>
					</div>
				</div>
			</div>
			<div class="thumbnail">
				...
				<div class="caption">
					...
					<div class="author">
						by <a target="_blank" href="mailto:fixed-term.Elaine.CAO@cn.bosch.com?subject=Suggestion for Quality Warning&body=Thanks for your email">Cao Elaine(AE/PJ-SME3-CN)</a>
					</div>
				</div>
			</div>
		</div>
